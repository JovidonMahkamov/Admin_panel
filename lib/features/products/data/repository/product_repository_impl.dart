...
class ProductRepositoryImpl implements ProductRepositories {
  ...
  @override
  Future<UpdateProductEntity> updateProduct({required int id, required String nomi, required String? narxDona, required String? narxMetr, required String? narxPochka, required String? pochka, required String? metr, required String? miqdor, required String? kelganNarx, required String? jamiNarx, File? rasm}) {
    return remote.updateProduct(id: id, nomi: nomi, narxDona: narxDona, narxMetr: narxMetr, narxPochka: narxPochka, pochka: pochka, metr: metr, miqdor: miqdor, kelganNarx: kelganNarx, jamiNarx: jamiNarx);
  }
}